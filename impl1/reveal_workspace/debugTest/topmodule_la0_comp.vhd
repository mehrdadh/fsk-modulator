-- =============================================================================
--  VHDL instance generated by IPExpress    05/22/2019    15:11:24         
--  Filename: topmodule_la0_inst.vhd                                          
...
PACKAGE topmodule_la0_pkg IS
    COMPONENT topmodule_la0
    PORT (
        clk:		IN std_logic;
        ...
        trace_din:	IN std_logic_vector (54 downto 0);
        ip_enable:	IN std_logic
    );

    END COMPONENT;

END PACKAGE topmodule_la0_pkg;
